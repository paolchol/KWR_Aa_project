...
#First test the process in a new script
#places the fucntions in functions_dp
...
#Noise
# train_X, test_X, train_y, test_y, noise_par = md.matrix_processing(df_noise, trainp, Nf, lag_in = IN, lag_out = OUT,
#                                                                    forward = forwardTF)
...
# n_fitted.save(f'{path_save}\model_Rlevel_noise.h5')
